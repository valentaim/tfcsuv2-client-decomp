...
public class TFC_Achievements
{
  ...
  public static void init() {
    ...
    achPokeCreeper = createAchievement("achievement.achPokeCreeper", "achPokeCreeper", -3, -3, new ItemStack(Items.field_151144_bL, 1, 4), null);
    ...
    achievementsTFC = achlist.<Achievement>toArray(achievementsTFC);
  ...
  private static Achievement createAchievement(String id, String name, int posX, int posY, ItemStack is, Achievement preReq) {
    Achievement a = (new Achievement(id, name, posX, posY, is, preReq)).func_75971_g();
    achlist.add(a);
    return a;
  }
}
