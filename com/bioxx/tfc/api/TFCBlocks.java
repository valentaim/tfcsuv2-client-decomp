...
/* 163 */   public static Block[] doors = new Block[Global.WOOD_ALL.length];
/*     */   
...
/* 247 */     return (block == woodSupportV || block == woodSupportV2);
/*     */   }
/*     */ 
/*     */   
/*     */   public static boolean isBlockHSupport(Block block) {
/* 252 */     return (block == woodSupportH || block == woodSupportH2);
/*     */   }
/*     */ 
/*     */   
/*     */   public static boolean isBlockAFence(Block block) {
/* 257 */     return (block == GrowthCraftCore.blocks.fenceRope.getBlock() || block == GrowthCraftCore.blocks.fenceRope2.getBlock() || block == fence || block == fence2 || BlockFence.func_149825_a(block));
/*     */   }
/*     */ 
/*     */   
/*     */   public static boolean canFenceConnectTo(Block block) {
/* 262 */     return (isBlockAFence(block) || block == fenceGate || block == fenceGate2);
/*     */   }
/*     */ 
/*     */   
/*     */   public static boolean isArmourStand(Block block) {
/* 267 */     return (block == armorStand || block == armorStand2);
/*     */   }
/*     */ }


/* Location:              D:\workdir\java\tfc\[1.7.10]TerraFirmaCraft-0.79.29.jar!\com\bioxx\tfc\api\TFCBlocks.class
