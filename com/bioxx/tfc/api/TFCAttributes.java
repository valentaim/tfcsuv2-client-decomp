...
public class TFCAttributes
{
  ...
  public static final AttributeModifier OVERBURDENED = (new AttributeModifier(OVERBURDENED_UUID, "Overburdened speed penalty", -1.0D, 2)).func_111168_a(false);
  public static final UUID THIRSTY_UUID = UUID.fromString("772A6B8D-DA3E-4C1C-9999-96EA6097278D");
  public static final AttributeModifier THIRSTY = (new AttributeModifier(THIRSTY_UUID, "Thirsty speed penalty", -0.3D, 2)).func_111168_a(false);
}
