...
public class GuiHopper
  ...
  public static ResourceLocation texture = new ResourceLocation("terrafirmacraft", "textures/gui/gui_hopper.png");
  
  public GuiHopper(InventoryPlayer inventoryplayer, TEHopper te, World world, int i, int j, int k) {
    super((Container)new ContainerHopper(inventoryplayer, (IInventory)te), 176, 49);
  }
