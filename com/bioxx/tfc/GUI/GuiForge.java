...
{
  public static ResourceLocation texture = new ResourceLocation("terrafirmacraft", "textures/gui/gui_forge.png");

  private TEForge forgeTE;


  public GuiForge(InventoryPlayer inventoryplayer, TEForge te, World world, int x, int y, int z) {
    super((Container)new ContainerForge(inventoryplayer, te, world, x, y, z), 176, 85);
    this.forgeTE = te;
  }
  ...
  protected void drawForeground(int guiLeft, int guiTop) {
    if (this.forgeTE != null) {

      int scale = this.forgeTE.getTemperatureScaled(49);
