  ...
  extends GuiContainer
{
  public GuiWorkbench(InventoryPlayer inventoryplayer, TEWorkbench wb, World world, int i, int j, int k) {
    super((Container)new ContainerWorkbench(inventoryplayer, wb, world, i, j, k));
  }
  ...
  protected void drawGuiContainerForegroundLayer() {
    this.field_146289_q.func_78276_b(TFC_Core.translate("gui.Workbench.Crafting"), 28, 6, 4210752);
    this.field_146289_q.func_78276_b(TFC_Core.translate("gui.Inventory"), 8, this.field_147000_g - 96 + 2, 4210752);
  }
