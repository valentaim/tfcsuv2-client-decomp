  ...
  extends GuiContainerTFC
{
  ...
  public GuiLargeVessel(InventoryPlayer inventoryplayer, TEVessel te, World world, int x, int y, int z, int tab) {
    super((Container)new ContainerLargeVessel(inventoryplayer, te, world, x, y, z, tab), 176, 85);
    this.vesselTE = te;
    ...
    extends GuiButton
  {
    ...
    public void func_146112_a(Minecraft par1Minecraft, int xPos, int yPos) {
      if (this.field_146125_m) {
        ...
        func_73732_a(fontrenderer, (GuiLargeVessel.this.vesselTE.mode == 0) ? TFC_Core.translate("gui.Barrel.ToggleOn") : TFC_Core.translate("gui.Barrel.ToggleOff"), this.field_146128_h + this.field_146120_f / 2, this.field_146129_i + (this.field_146121_g - 8) / 2, l);
      }
    }
  }
  ...
  protected void func_146976_a(float f, int mouseX, int mouseY) {
    ...
    if (this.guiTab == 0) {
      ...
      func_73729_b(w, h, 0, 0, this.field_146999_f, getShiftedYSize());
      ...
      if (this.vesselTE != null && this.vesselTE.fluid != null) {
        ...
        int rem = scale - div * 8;
        func_94065_a(w + 12, h + 65 - scale, liquidIcon, 8, (div > 0) ? 8 : rem);
        for (int c = 0; div > 0 && c < div; c++)
        {
          func_94065_a(w + 12, h + 65 - 8 + c * 8, liquidIcon, 8, 8);
        }
      ...
      if (this.vesselTE.getFluidStack() != null) {
        func_73732_a(this.field_146289_q, this.vesselTE.fluid.getFluid().getLocalizedName(this.vesselTE.getFluidStack()), this.field_147003_i + 88, this.field_147009_r + 7, 5592405);
      }

      if (this.vesselTE.sealtime != 0)
      {
        func_73732_a(this.field_146289_q, TFC_Time.getDateStringFromHours(this.vesselTE.sealtime), this.field_147003_i + 88, this.field_147009_r + 17, 5592405);
      }


      if (this.vesselTE.recipe != null) {

        if (!(this.vesselTE.recipe instanceof com.bioxx.tfc.api.Crafting.BarrelBriningRecipe))
        {
          func_73732_a(this.field_146289_q, TFC_Core.translate("gui.Output") + ": " + this.vesselTE.recipe.getRecipeName(), this.field_147003_i + 88, this.field_147009_r + 72, 5592405);
        }
        else if (this.vesselTE.getSealed() && this.vesselTE.getFluidStack() != null && this.vesselTE.getFluidStack().getFluid() == TFCFluids.BRINE)
        {
      ...
      } else if (this.vesselTE.recipe == null && this.vesselTE.getSealed() && this.vesselTE.getFluidStack() != null && inStack != null && inStack.func_77973_b() instanceof IFood && this.vesselTE
        .getFluidStack().getFluid() == TFCFluids.VINEGAR && !Food.isPickled(inStack) && Food.getWeight(inStack) / (this.vesselTE.getFluidStack()).amount <= 160.0F / this.vesselTE.getMaxLiquid()) {
        ...
        BarrelPreservativeRecipe preservative = BarrelManager.getInstance().findMatchingPreservativeRepice((TEBarrel)this.vesselTE, inStack, this.vesselTE.getFluidStack(), this.vesselTE.getSealed());
      ...
      func_73729_b(w, h, 0, 86, this.field_146999_f, getShiftedYSize());
    }
