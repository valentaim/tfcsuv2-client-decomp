...
{
  public static ResourceLocation texture = new ResourceLocation("terrafirmacraft", "textures/gui/gui_quern.png");


  public GuiQuern(InventoryPlayer inventoryplayer, TEQuern te, World world, int x, int y, int z) {
    super((Container)new ContainerQuern(inventoryplayer, te, world, x, y, z), 176, 85);
  }
