...
{
  public static ResourceLocation texture = new ResourceLocation("terrafirmacraft", "textures/gui/gui_logpile.png");

  
  public GuiLogPile(InventoryPlayer inventoryplayer, TELogPile te, World world, int x, int y, int z) {
    super((Container)new ContainerLogPile(inventoryplayer, te, world, x, y, z), 176, 85);
  }
