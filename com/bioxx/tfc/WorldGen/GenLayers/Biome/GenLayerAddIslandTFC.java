  ...
  extends GenLayerTFC
{
  ...
  public int[] func_75904_a(int par1, int par2, int par3, int par4) {
    ...
    int[] var10 = IntCache.func_76445_a(par3 * par4);
    ...
    for (int var11 = 0; var11 < par4; var11++) {
      ...
      for (int var12 = 0; var12 < par3; var12++) {
        ...
        func_75903_a((var12 + par1), (var11 + par2));
        ...
        if (var17 == 0 && (var13 != 0 || var14 != 0 || var15 != 0 || var16 != 0)) {
          ...
          if (var13 != 0 && func_75902_a(var18++) == 0) {
            var19 = var13;
          }
          if (var14 != 0 && func_75902_a(var18++) == 0) {
            var19 = var14;
          }
          if (var15 != 0 && func_75902_a(var18++) == 0) {
            var19 = var15;
          }
          if (var16 != 0 && func_75902_a(var18++) == 0) {
            var19 = var16;
          }
          if (func_75902_a(3) == 0) {
