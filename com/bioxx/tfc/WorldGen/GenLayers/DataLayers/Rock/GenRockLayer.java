...
public abstract class GenRockLayer
  ...
  public static GenLayerTFC initialize(long par0, DataLayer[] rocks) {
    ...
    for (int zoomLevel = 0; zoomLevel < 5; zoomLevel++) {
      ...
      drawImage(512, (GenLayerTFC)genLayerZoomTFC1, "Rock " + (7 + zoomLevel));
    }
    ...
    drawImage(512, (GenLayerTFC)genLayerZoomTFC1, "Rock Final");
    smoothedLayer.func_75905_a(par0);
