    ...
    for (int var11 = 0; var11 < zSize; var11++) {
      ...
      for (int var12 = 0; var12 < xSize; var12++) {
        ...
        if (id0 > thisID || id1 > thisID || id2 > thisID || id3 > thisID) {
          ...
          if (id0 != 0 && func_75902_a(count++) == 0) {
            outID = id0 + 1;
          }
          if (id1 != 0 && func_75902_a(count++) == 0) {
            outID = id1 + 1;
          }
          if (id2 != 0 && func_75902_a(count++) == 0) {
            outID = id2 + 1;
          }
          if (id3 != 0 && func_75902_a(count++) == 0) {
            outID = id3 + 1;
          }
          if (func_75902_a(3) == 0 && outID <= GenRainLayerTFC.WET) {
          ...
          if (func_75902_a(3) == 0 && outID >= GenRainLayerTFC.DRY) {
            outCache[var12 + var11 * xSize] = outID;
          } else {
            outCache[var12 + var11 * xSize] = thisID;
          } 
