    ...
    for (int var7 = 0; var7 < zSize; var7++) {
      ...
      for (int var8 = 0; var8 < xSize; var8++) {
        ...
        if ((id0 >= thisID + 2 || id1 >= thisID + 2 || id2 >= thisID + 2 || id3 >= thisID + 2) &&
          thisID + 1 < DataLayer.RAIN_8000.layerID)
          thisID++;
        if ((id0 <= thisID - 2 || id1 <= thisID - 2 || id2 <= thisID - 2 || id3 <= thisID - 2) &&
          thisID - 1 > DataLayer.RAIN_62_5.layerID) {
          thisID--;
        }
...
/* Location:              D:\workdir\java\tfc\[1.7.10]TerraFirmaCraft-0.79.29.jar!\com\bioxx\tfc\WorldGen\GenLayers\DataLayers\Rain\GenLayerRainMix.class
