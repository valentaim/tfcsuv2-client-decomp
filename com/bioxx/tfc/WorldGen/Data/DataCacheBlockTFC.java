...
public class DataCacheBlockTFC
{
  ...
  public DataCacheBlockTFC(DataCache datacache, GenLayerTFC indexLayers, int par2, int par3, int ind) {
    ...
    this.zPosition = par3;
    this.index = ind;
    DataCache.getChunkManager(datacache).getDataLayerAt(datacache, this.data, indexLayers, par2 << 4, par3 << 4, 16, 16, false, this.index);
  }
  ...
  public DataLayer getDataLayerAt(int par1, int par2) {
    return this.data[par1 & 0xF | (par2 & 0xF) << 4];
  }
}
