  ...
  extends CommandBase
{
  ...
  public void func_71515_b(ICommandSender sender, String[] params) {
    ...
    float t = TFC_Climate.getBioTemperatureHeight(var4.field_70170_p, (int)var4.field_70165_t, (int)var4.field_70163_u, (int)var4.field_70161_v);
    throw new PlayerNotFoundException("BioTemp: " + t, new Object[0]);
  }
