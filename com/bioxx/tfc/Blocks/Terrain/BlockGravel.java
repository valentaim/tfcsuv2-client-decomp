  ...
  extends BlockTerra
{
  ...
  public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune) {
    ...
    if (world.field_73012_v.nextInt(10 - fortune * 3) == 0) {

      ret.add(new ItemStack(Items.field_151145_ak, 1));
    }
    else {

      ret.add(new ItemStack(Item.func_150898_a((Block)this), 1, func_149692_a(metadata)));
    }
    return ret;
  }
  ...
  public void func_149651_a(IIconRegister registerer) {
    ...
    for (int i = 0; i < count; i++) {
      this.icons[i] = registerer.func_94245_a("terrafirmacraft:soil/Gravel " + Global.STONE_ALL[i + this.textureOffset]);
    }
  }
