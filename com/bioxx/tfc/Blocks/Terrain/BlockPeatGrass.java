  ...
  extends BlockGrass
{
  ...
  public Item func_149650_a(int metadata, Random rand, int fortune) {
    return Item.func_150898_a(TFCBlocks.peat);
  }
  ...
  public void func_149695_a(World world, int x, int y, int z, Block b) {
    if (!world.func_72899_e(x, y - 1, z)) {

      int meta = world.func_72805_g(x, y, z);
      world.func_147465_d(x, y, z, TFCBlocks.peat, meta, 2);
    }
  }
  ...
  public void func_149674_a(World world, int x, int y, int z, Random rand) {
    if (world.func_147439_a(x, y + 1, z).isSideSolid((IBlockAccess)world, x, y + 1, z, ForgeDirection.DOWN)) {
      world.func_147449_b(x, y, z, TFCBlocks.peat);
