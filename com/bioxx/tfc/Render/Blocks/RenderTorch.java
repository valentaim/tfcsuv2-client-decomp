  ...
  implements ISimpleBlockRenderingHandler
{
  public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
    ...
    if ((meta & 0x7) == 1) {
      ...
      renderer.func_147747_a(block, x - d1, y + d2, z, -d0, 0.0D, meta);
    }
    else if ((meta & 0x7) == 2) {
      ...
      renderer.func_147747_a(block, x, y + d2, z - d1, 0.0D, -d0, meta);
    }
    else if ((meta & 0x7) == 4) {
      ...
      renderer.func_147747_a(block, x, y, z, 0.0D, 0.0D, meta);
    }
