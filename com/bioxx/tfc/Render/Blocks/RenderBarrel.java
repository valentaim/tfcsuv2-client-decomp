  ...
  public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
    ...
    if ((te.rotation & Byte.MIN_VALUE) == 0) {
      ...
      if (te.getSealed()) {
        ...
        renderer.func_147782_a(0.15000000596046448D, 0.10000000149011612D, 0.15000000596046448D, 0.8499999642372131D, 0.949999988079071D, 0.8499999642372131D);
        renderer.func_147784_q(lidBlock, x, y, z);
      }
      else {

        renderer.func_147782_a(0.15000000596046448D, 0.10000000149011612D, 0.15000000596046448D, 0.8499999642372131D, 0.15000000596046448D, 0.8499999642372131D);
        renderer.func_147784_q(lidBlock, x, y, z);
        ...
        if (te.fluid != null && renderer.field_147840_d == null) {
          ...
          renderer.func_147782_a(0.15000000596046448D, 0.1500000014901161D, 0.15000000596046448D, 0.8499999642372131D, (0.15F + h), 0.8499999642372131D);
          IIcon still = te.fluid.getFluid().getStillIcon();
          renderer.func_147757_a(still);
          renderer.func_147736_d(lidBlock, x, y, z, f, f1, f2);
          renderer.func_147771_a();
        }
      }
      renderer.func_147782_a(0.10000000149011612D, 0.0D, 0.15000000596046448D, 0.15000000596046448D, 1.0D, 0.8499999642372131D);
      rotate(renderer, 1);
      renderer.func_147784_q(planksBlock, x, y, z);

      renderer.func_147782_a(0.8499999642372131D, 0.0D, 0.15000000596046448D, 0.8999999761581421D, 1.0D, 0.8499999642372131D);
      rotate(renderer, 1);
      renderer.func_147784_q(planksBlock, x, y, z);

      renderer.func_147782_a(0.10000000149011612D, 0.0D, 0.10000000149011612D, 0.8999999761581421D, 1.0D, 0.15000000596046448D);
      rotate(renderer, 1);
      renderer.func_147784_q(planksBlock, x, y, z);

      renderer.func_147782_a(0.10000000149011612D, 0.0D, 0.8499999642372131D, 0.8999999761581421D, 1.0D, 0.8999999761581421D);
      rotate(renderer, 1);
      renderer.func_147784_q(planksBlock, x, y, z);

      renderer.func_147782_a(0.09900000149011612D, 0.0D, 0.09900000149011612D, 0.9009999761581421D, 1.0D, 0.9009999761581421D);
      rotate(renderer, 0);
      ...
      if ((te.rotation & 0x3) == 0) {
        ...
        renderer.func_147782_a(0.10000000149011612D, 0.10000000149011612D, 0.15000000596046448D, 0.949999988079071D, 0.15000000596046448D, 0.8499999642372131D);
        renderer.func_147784_q(lidBlock, x, y, z);
      }
      if ((te.rotation & 0x3) == 1) {

        renderer.func_147782_a(0.15000000596046448D, 0.10000000149011612D, 0.10000000149011612D, 0.8499999642372131D, 0.15000000596046448D, 0.949999988079071D);
        renderer.func_147784_q(lidBlock, x, y, z);
      }
    }
