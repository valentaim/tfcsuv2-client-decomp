  ...
  extends TESRBase
{
  public void renderAt(TEFoodPrep te, double d, double d1, double d2, float f) {
    if (te.func_145831_w() != null) {
      ...
      if (RenderManager.field_78727_a.field_78733_k.field_74347_j) {
        ...
        if (te.func_70301_a(6) != null)
        {
          GL11.glPushMatrix();
          GL11.glTranslatef((float)d + 0.75F, (float)d1 + 0.0F, (float)d2 + 0.75F);
          GL11.glRotatef(timeD, 0.0F, 1.0F, 0.0F);
          GL11.glScalef(blockScale, blockScale, blockScale);
          customitem.func_92058_a(te.func_70301_a(6));
          itemRenderer.func_76986_a(customitem, 0.0D, 0.0D, 0.0D, 0.0F, 0.0F);
          GL11.glPopMatrix();
        }
        ...
        drawItem(te, 6, 0.65D, 0.95D, 0.65D, 0.95D);
        GL11.glPopMatrix();
      }
    }
  }
  ...
  public void drawItem(TEFoodPrep te, int index, double minX, double maxX, double minZ, double maxZ) {
    if (te.storage[index] != null && !(te.storage[index].func_77973_b() instanceof net.minecraft.item.ItemBlock)) {
  ...
  public void func_147500_a(TileEntity par1TileEntity, double par2, double par4, double par6, float par8) {
    renderAt((TEFoodPrep)par1TileEntity, par2, par4, par6, par8);
  }
}
