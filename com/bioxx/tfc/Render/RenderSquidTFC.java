  ...
  extends RenderSquid
{
  ...
  protected float func_77044_a(EntitySquid par1EntitySquid, float par2) {
    return par1EntitySquid.field_70865_by + (par1EntitySquid.field_70866_j - par1EntitySquid.field_70865_by) * par2;
  }
  ...
  protected float func_77044_a(EntityLivingBase par1EntityLiving, float par2) {
    return func_77044_a((EntitySquid)par1EntityLiving, par2);
  }



  protected void func_77043_a(EntityLivingBase par1EntityLiving, float par2, float par3, float par4) {
    func_77043_a((EntitySquid)par1EntityLiving, par2, par3, par4);
  }
  ...
  public void func_76986_a(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
    func_76986_a((EntitySquid)par1Entity, par2, par4, par6, par8, par9);
  }
}
