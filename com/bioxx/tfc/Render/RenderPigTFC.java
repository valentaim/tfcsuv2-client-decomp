  ...
  extends RenderPig
{
  ...
  protected void func_77041_b(EntityLivingBase par1EntityLivingBase, float par2) {
    float scale = ((EntityPigTFC)par1EntityLivingBase).getSizeMod() / 2.0F + 0.5F;
  ...
  protected ResourceLocation func_110775_a(Entity entity) {
    return ((EntityPigTFC)entity).isAdult() ? new ResourceLocation("terrafirmacraft", "textures/mob/boara.png") : new ResourceLocation("terrafirmacraft", "textures/mob/boarb.png");
  }
}
