  ...
  implements IShearable, IAnimal
{
  ...
  public EntitySheepTFC(World par1World) {
    ...
    this.sizeMod = (float)Math.sqrt((((this.field_70146_Z.nextInt(this.field_70146_Z.nextInt(30) + 1) * (this.field_70146_Z.nextBoolean() ? 1 : -1)) * 0.01F + 1.0F) * (1.0F - 0.1633F * this.sex)));
  ...
  public boolean func_70601_bi() {
    ...
    if ((isMountainous && temp < 25.0F && temp > -10.0F) || (temp > -20.0F && temp <= 0.0F && rain > 250.0F))
  ...
  public boolean canMateWith(IAnimal animal) {
    return (animal.getGender() != getGender() && isAdult() && animal.isAdult() && animal instanceof EntitySheepTFC);
  }
  ...
  public int combineColors(EntityAnimal parent, int mateColor) {
    int babyColor, parent1Color = 15 - ((EntitySheep)parent).func_70896_n();
    ...
    if (itemstack != null && itemstack.func_77973_b() == Items.field_151100_aR) {
      ...
      babyColor = itemstack.func_77960_j();
    }
    else {

      babyColor = this.field_70170_p.field_73012_v.nextBoolean() ? parent1Color : parent2Color;
    }
  ...
  public EntityAgeable createChildTFC(EntityAgeable eAgeable) {
    ...
    int colorMeta = combineColors((EntityAnimal)this, ((EntitySheepTFC)eAgeable).mateColor);
  ...
  protected void func_70628_a(boolean par1, int par2) {
    ...
    if (!func_70892_o()) {
      func_70099_a(new ItemStack(TFCItems.sheepSkin, 1, Math.max(0, Math.min(2, (int)(ageMod * this.sizeMod)))), 0.0F);
    } else {
      func_70099_a(new ItemStack(TFCItems.hide, 1, Math.max(0, Math.min(2, (int)(ageMod * this.sizeMod)))), 0.0F);
    }
    func_145779_a(Items.field_151103_aS, (int)((this.field_70146_Z.nextInt(5) + 2) * ageMod));
  ...
  public void familiarize(EntityPlayer ep) {
    ...
    if (stack != null && !this.familiarizedToday && isFood(stack) && canFamiliarize()) {
  ...
  public int getNumberOfDaysToAdult() {
    return (int)(TFCOptions.animalTimeMultiplier * TFC_Time.daysInMonth * 12.0F);
  }
  ...
  public boolean func_70085_c(EntityPlayer player) {
    if (!this.field_70170_p.field_72995_K) {
      ...
      if (player.func_70694_bm() != null && player.func_70694_bm().func_77973_b() instanceof com.bioxx.tfc.Items.Tools.ItemKnife && !func_70892_o() && checkFamiliarity(IAnimal.InteractionEnum.SHEAR, player) && isAdult())

      { if (System.currentTimeMillis() > this.lasttick + 500L)
        { this.ticks = (byte)(this.ticks + 1);
          this.lasttick = System.currentTimeMillis(); }
        else { this.ticks = 0; }
         if (this.ticks < 10) return false;
  ...
  public void func_70636_d() {
    ...
    if (!this.field_70170_p.field_72995_K && isPregnant() &&
      TFC_Time.getTotalTicks() >= this.timeOfConception + this.pregnancyRequiredTime) {

      int i = this.field_70146_Z.nextInt(3) + 1;
      for (int x = 0; x < i; x++) {

        EntitySheepTFC baby = (EntitySheepTFC)createChildTFC((EntityAgeable)this);
