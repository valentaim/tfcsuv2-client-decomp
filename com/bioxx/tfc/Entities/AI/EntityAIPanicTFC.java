  ...
  extends EntityAIBase
{
  ...
  public boolean func_75250_a() {
    if (this.theEntityCreature.func_70643_av() == null && !this.theEntityCreature.func_70027_ad() && ((this.theEntityCreature instanceof IAnimal && ((IAnimal)this.theEntityCreature)
      .getAttackedVec() == null) || !(this.theEntityCreature instanceof IAnimal)))
    {
    ...
    if (attackedVec != null) {
      ...
      vec3 = RandomPositionGenerator.func_75461_b(this.theEntityCreature, 5, 4, attackedVec);
    }
    if (vec3 == null)
    {
      return false;
    ...
    if (this.alertHerd && this.theEntityCreature instanceof IAnimal) {
      ...
      List list = this.theEntityCreature.field_70170_p.func_72872_a(this.theEntityCreature.getClass(), this.theEntityCreature.field_70121_D
          .func_72314_b(8.0D, 8.0D, 8.0D));
  ...
  public Vec3 updateAttackVec(IAnimal theCreature, Vec3 attackedVec) {
    if (theCreature.getFearSource() != null &&
      TFC_Core.getEntityPos((Entity)this.theEntityCreature).func_72438_d(attackedVec) > this.theEntityCreature.func_70032_d(theCreature.getFearSource())) {

      Vec3 newVec = Vec3.func_72443_a((theCreature.getFearSource()).field_70165_t, (theCreature.getFearSource()).field_70163_u, (theCreature.getFearSource()).field_70161_v);
