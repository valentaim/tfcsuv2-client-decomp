  ...
  extends ContainerTFC
{
    ...
    if (this.player.field_71071_by.func_70301_a(this.bagsSlotNum) != null && this.player.field_71071_by
      ...
      for (int i = 0; i < nbttaglist.func_74745_c(); i++) {
        ...
        if (byte0 >= 0 && byte0 < 4) {
          ...
          ItemStack is = ItemStack.func_77949_a(nbttagcompound1);
          if (is.field_77994_a >= 1) {
            this.containerInv.func_70299_a(byte0, is);
          } else {
            this.containerInv.func_70299_a(byte0, null);
          }
        }
      }
    }
  ...
  public void saveContents(ItemStack is) {
    ...
    for (int i = 0; i < this.containerInv.func_70302_i_(); i++) {
      ...
      if (contentStack != null && contentStack.func_77973_b() instanceof com.bioxx.tfc.api.Interfaces.IFood)
      {
        if (Food.getDecay(contentStack) / 160.0F > 0.9F)
  ...
  protected void layoutContainer(IInventory playerInventory, int xSize, int ySize) {
    func_75146_a((Slot)(new SlotSizeSmallVessel((IInventory)this.containerInv, 0, 71, 25)).addItemException(this.exceptions));
    func_75146_a((Slot)(new SlotSizeSmallVessel((IInventory)this.containerInv, 1, 89, 25)).addItemException(this.exceptions));
    func_75146_a((Slot)(new SlotSizeSmallVessel((IInventory)this.containerInv, 2, 71, 43)).addItemException(this.exceptions));
    func_75146_a((Slot)(new SlotSizeSmallVessel((IInventory)this.containerInv, 3, 89, 43)).addItemException(this.exceptions));
